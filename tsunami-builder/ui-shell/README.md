...
- `tools/generate_tsunami_sans.py` procedural TSUNAMI Sans v4.7 source/generator: five weight-specific geometric masters with explicit screen-legibility control glyphs
